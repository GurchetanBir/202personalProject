...
public class ParserClass {
	...
	private String equalFieldName(BodyDeclaration bodyDeclaration, String fieldN) {
	  ...
	  private String nextParam(String methods, final boolean nextParameter) {
			if (nextParameter)
			    methods += ";";
			return methods;
		}
		...
		private String  paramClassAddition2(final String classShortName, String additions, final String paramClass) {
			if ((map.containsKey(paramClass) && !map.get(classShortName))) {
		...
		private String paramClassAddition(String additions, final String paramClass) {
